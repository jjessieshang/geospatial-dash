...
file_location = 'data/Geospatial Data/chsa_2022_wgs.geojson'
...
print(jdata['features'][18]['properties']['CHSA_CD'])
# print(jdata['features'][9]['geometry']['coordinates'])

chsa_name = jdata['features'][18]['properties']['CHSA_Name']
chsa_cd = jdata['features'][18]['properties']['CHSA_CD']
data = {'id': [chsa_name], 'value': [chsa_cd]}
gdf = pd.DataFrame(data)

fig7= go.Figure(go.Choroplethmapbox(
                            geojson=jdata,
                            locations=gdf['id'],
                            z=gdf['value'],
                            colorscale='reds',
    ...
    html.Div(className="main-row", children=[
        ...
        html.Div(className="column2", children=[
                ...
                html.Div(className="table", 
                    ...
                    html.A("Go to New Page", href="map.py")
                ]),
                                # stacked bar
