...
layout = html.Div(className="main-row", children=[
    html.Div(className="column1", children=[
        ...
        html.P(className="section-description", 
            children=["EX plore the estimated costs that patients and their families pay for four types of care across British Columbia. Click on the bar graph to view a breakdown of the visitation costs."]),
        # dropdown menus
